...
class ContactoController extends AbstractController
{
    ...
    public function sendContact(Request $request, EntityManagerInterface $entityManager, EmailService $emailService)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
	        ...
	        try {
	            $entityManager->flush();
                $sendEmail = $emailService->sendEmail('email/email_contact.html.twig', 'Has recibido una consulta', 'automovileslucen@automovileslucentum.com', 'automovileslucentum@gmail.com', $contact);

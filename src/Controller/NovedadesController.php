    ...
    */
    public function commentPost(Request $request, EntityManagerInterface $entityManager, EmailService $emailService) {
        if ($request->get('comment')) {
            ...
            try {
                $entityManager->flush();
                $sendEmail = $emailService->sendEmail('email/email.html.twig', 'Has recibido un comentario', 'automovileslucen@automovileslucentum.com', 'automovileslucentum@gmail.com', $comment);
